    ...
    return (
        <nav className="relative bg-white shadow dark:bg-gray-800">
            <div className="container px-6 py-3 mx-auto md:flex">
                    ...
                    <Link to={'/'}>
                        <div className="flex items-center gap-2">
                            <img
                                ...
                                alt="Logo"
                            />
                            <h1 className="text-xl font-semibold">Gallery360</h1>
                        </div>
                    </Link>
                ...
                >
                    <div className="flex flex-col px-2 -mx-4 md:flex-row md:mx-10 md:py-0 text-xl font-semibold">
                        <NavLink
                            to="/"
                            className="px-2.5 py-2 text-gray-700 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 md:mx-2 hover:text-blue-600"
                        >
                            Home
                        </NavLink>
                        <NavLink
